...
// Import the main PatchDashboard component (you can customize this)
// For this example, we'll inline a version with sample data
...
export default function PatchDashboardExample() {
  const [activeTab, setActiveTab] = useState('dashboard');

  // Sample data showing populated dashboard
  ...
  const charts: ChartData[] = [
    {
      ...
      series: [2, 3, 1, 4, 3, 2, 5, 4, 3, 2, 3, 1, 2, 3, 4, 5, 3, 2, 1, 2, 3, 4, 2, 1],
    },
    {
      period: 'LAST 7 DAYS',
      runs: 124,
    ...
    },
    {
      ...
      failed: 34,
      trendLabel: 'RUNS PER DAY',
      series: [15, 18, 16, 14, 19, 22, 20, 18, 17, 15, 14, 16, 19, 21, 23, 20, 18, 16, 15, 17, 19, 22, 24, 21, 18, 16, 15, 17, 19, 20],
    },
  ];

  const recentUpdates: RecentUpdate[] = [
    { id: '1', timestamp: '2026-07-01 14:32:15', system: 'web-server-01', status: 'success' },
    { id: '2', timestamp: '2026-07-01 14:28:42', system: 'db-primary-02', status: 'success' },
    { id: '3', timestamp: '2026-07-01 14:15:08', system: 'app-worker-03', status: 'failed' },
    { id: '4', timestamp: '2026-07-01 13:55:21', system: 'cache-redis-01', status: 'success' },
    { id: '5', timestamp: '2026-07-01 13:42:17', system: 'api-gateway-04', status: 'success' },
  ];
