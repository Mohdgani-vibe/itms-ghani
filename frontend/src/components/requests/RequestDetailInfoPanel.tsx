...
export default function RequestDetailInfoPanel({
  ...
  return (
    <div className="grid gap-3 rounded-2xl border border-emerald-100 bg-[linear-gradient(180deg,_#ffffff_0%,_rgba(240,253,244,0.9)_100%)] p-4 shadow-sm sm:grid-cols-3">
      <div className="rounded-xl border border-emerald-100 bg-white/90 px-3 py-3">
        ...
        {canOpenRequester ? (
          <button type="button" onClick={onOpenRequester} className="mt-1 text-left text-sm font-semibold text-emerald-700 hover:text-emerald-800">
            {requesterName}
          </button>
        ) : (
      ...
      <div className="rounded-xl border border-emerald-100 bg-white/90 px-3 py-3">
        ...
        {canOpenAssignee ? (
          <button type="button" onClick={onOpenAssignee} className="mt-1 text-left text-sm font-semibold text-emerald-700 hover:text-emerald-800">
            {assigneeName}
          </button>
        ) : (
