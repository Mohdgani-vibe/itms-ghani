...
export default function RequestsQueueSection({
  ...
  return (
    <section className={`overflow-hidden rounded-2xl border shadow-sm ${tone.shell}`}>
      <div className="border-b border-emerald-100/80 bg-[linear-gradient(180deg,_#ffffff_0%,_#f4fbf6_100%)] px-5 py-4">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="rounded-2xl bg-white/90 px-4 py-3 text-right shadow-sm ring-1 ring-emerald-100">
