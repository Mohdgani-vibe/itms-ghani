...
- Frontend UI is served on `http://YOUR_SERVER_IP:4175`
- Live backend API is served on `http://YOUR_SERVER_IP:3013`
...
- `VITE_API_ORIGIN=http://YOUR_SERVER_IP:3013`
- `VITE_WS_ORIGIN=ws://YOUR_SERVER_IP:3013`
